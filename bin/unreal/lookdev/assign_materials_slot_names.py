...
DIR_PATH = '/Game/Assets/S002_Material/'
material_list = "J:/mats.json"
    ...
    with unreal.ScopedSlowTask(len(material_slot_values)) as slow_task:
        ...
        for x in range(len(material_slot_values)):
            ...
            if slow_task.should_cancel():
                break
            slow_task.enter_progress_frame(1, 'Assigning materials to slots... ' + str(x) + ' / ' + str(len(material_slot_values)))
            for v in material_slot_values:
                ...
                if material_name in material_dictionary:
                    ...
                    for d in mesh:
                        ...
                        material_example = unreal.EditorAssetLibrary.load_asset(material_path)
